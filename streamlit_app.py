...
if menu == "Then vs Now":
    ...
    with col1:
        ...
        st.image(historical_image, caption="Chandni Chowk, Delhi - circa 1900", use_column_width=True)
        st.image(historical_image2, caption="Varanasi (Benares) - circa 1905", use_column_width=True)
    with col2:
        st.subheader("Now (Modern India)")
        st.image(modern_image, caption="Mumbai Skyline at Night", use_column_width=True)
        st.image(modern_image2, caption="Bandra-Worli Sea Link, Mumbai", use_column_width=True)
...
# Gallery View
    ...
    st.header("Gallery")
    st.image([historical_image, historical_image2, modern_image, modern_image2],
             caption=["Chandni Chowk, Delhi - 1900s", "Varanasi - 1905", "Mumbai Skyline", "Bandra-Worli Sea Link"],
...
# About & CMS Vision View
    ...
    **Profession:** Indian Air Force Test Pilot & ISRO Astronaut  
    ...
    Group Captain **Shubhanshu Shukla** is a decorated IAF test pilot and ISRO astronaut, the first Indian in over 40 years to visit the International Space Station since Rakesh Sharma.  
    Selected in 2019 for India's human spaceflight ambitions, Shukla joined the elite Gaganyatri group, undergoing rigorous training in Russia and India.  
    He flew as mission pilot on **Axiom Mission 4**, completing over 60 scientific experiments in space during an 18-day orbit before safely returning.  
    ...
    st.markdown("""
    *CMS instilled in me a spirit of curiosity, perseverance, and community — a foundation that guided me from classroom ambition to the threshold of space.  
    I hope my journey inspires every young mind to dare beyond limits.*  

    CMS continues to foster global-minded learners ready to lead change, shaping students to become responsible world citizens who contribute to peace and progress.
    """)
